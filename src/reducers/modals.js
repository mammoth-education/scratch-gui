...
const MODAL_USER_PROJECTS = 'userProjectsModal';
...
const openUserProjectsModal = function () {
    return openModal(MODAL_USER_PROJECTS);
};
...
const closeUserProjectsModal = function () {
    return closeModal(MODAL_USER_PROJECTS);
};
export {
    reducer as default,
